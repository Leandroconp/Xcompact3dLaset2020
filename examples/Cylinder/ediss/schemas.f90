...
real(8),dimension(nxm) :: cfx6,ccx6,cbx6,cfxp6,ciwxp6
...
real(8),dimension(nx) :: cfip6,csip6,cwip6,csi6  
real(8),dimension(nx) :: cwi6,cifi6,cici6,cibi6,cifip6  
real(8),dimension(nx) :: cisip6,ciwip6,cisi6,ciwi6 
real(8),dimension(nym) :: cfy6,ccy6,cby6 
real(8),dimension(nym) :: cfyp6,csyp6,cwyp6,csy6 
real(8),dimension(nym) :: cwy6,cify6,cicy6,ciby6,cifyp6  
real(8),dimension(nym) :: cisyp6,ciwyp6,cisy6,ciwy6 
real(8),dimension(ny) :: cfi6y,cci6y,cbi6y,cfip6y  
real(8),dimension(ny) :: csip6y,cwip6y,csi6y,cwi6y,cifi6y,cici6y  
real(8),dimension(ny) :: cibi6y,cifip6y  
real(8),dimension(ny) :: cisip6y,ciwip6y,cisi6y,ciwi6y   
real(8),dimension(nzm) :: cfz6,ccz6,cbz6 
real(8),dimension(nzm) :: cfzp6,cszp6,cwzp6,csz6 
real(8),dimension(nzm) :: cwz6,cifz6,cicz6,cibz6,cifzp6  
real(8),dimension(nzm) :: ciszp6,ciwzp6,cisz6,ciwz6 
real(8),dimension(nz) :: cfi6z,cci6z,cbi6z,cfip6z  
real(8),dimension(nz) :: csip6z,cwip6z,csi6z,cwi6z,cifi6z,cici6z  
real(8),dimension(nz) :: cibi6z,cifip6z 
real(8),dimension(nz) :: cisip6z,ciwip6z,cisi6z,ciwi6z 
real(8) :: fpi2
integer :: i, j, k 
