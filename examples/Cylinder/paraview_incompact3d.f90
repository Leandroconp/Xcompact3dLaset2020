program visu_paraview
  ...
  integer(4) :: i, j, k, num, aig, ii, nfil,istret,nclx, ncly, nclz, ioutput

!IF THE DATA ARE STORED WITH 3 DIGITS, IE UX001,UX002,ETC.
!  character(3) :: chits
!IF THE DATA ARE STORED WITH 4 DIGITS, IE UX0001,UX0002,ETC.
!  character(4) :: chits
!IF THE DATA ARE STORED WITH 5 DIGITS, IE UX0001,UX0002,ETC.
!  character(5) :: chits
!IF THE DATA ARE STORED WITH 9 DIGITS, IE UX0001,UX0002,ETC.
  character(9) :: chits
